package
{
	...
	public class ForceTest extends Sprite
	{
		...
		public function ForceTest()
		{
			...
			FFForceManager.getIntsance().getForce(FFFForceGravity.NAME).addParticle(shot.p).addParticle(shot2.p);
			FFForceManager.getIntsance().getForce(FFForceDrag.NAME).addParticle(shot.p);
